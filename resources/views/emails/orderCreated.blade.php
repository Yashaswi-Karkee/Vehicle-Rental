    ...
    <table role="presentation" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td style="background-color: #ffffff; padding: 20px;">
                <h2 style="color: #333; font-size: 24px; margin: 0;">Order Request Received</h2>
                <p style="color: #666; font-size: 16px; margin: 20px 0;">
                    You have received an Order. Please check your "Order Requests" panel for further processing.
                </p>
