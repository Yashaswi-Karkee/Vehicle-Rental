                    ...
                    @foreach ($order as $or)
                                ...
                                <div class="p-4">
                                    ...
                                    @if ($temp1)
                                        <div class="mt-4 flex justify-center">
                                            ...
                                            <a href="{{ route('write.review', $or->id) }}"
                                                class="text-indigo-500 hover:underline">Write a Review</a>
                        ...
                        @else
                            ...
                            <div class="mt-6 p-8 rounded-lg border border-gray-200 flex items-center justify-center">
                                <p class="text-lg font-semibold text-gray-800">No orders found at the moment.</p>
                            </div>
                        @endif
                    @endforeach
                </ul>
